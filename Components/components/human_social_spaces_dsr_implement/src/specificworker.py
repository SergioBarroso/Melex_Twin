...
class SpecificWorker(GenericWorker):
    ...
    def startup_check(self):
        print(f"Testing RoboCompHumanToDSR.TJointData from ifaces.RoboCompHumanToDSR")
        test = ifaces.RoboCompHumanToDSR.TJointData()
        print(f"Testing RoboCompHumanToDSR.Person from ifaces.RoboCompHumanToDSR")
        test = ifaces.RoboCompHumanToDSR.Person()
        print(f"Testing RoboCompHumanToDSR.PeopleData from ifaces.RoboCompHumanToDSR")
        test = ifaces.RoboCompHumanToDSR.PeopleData()
