...
#include  "/home/robolab/robocomp/components/MelexCar_private/EDGEC/etc/melex1_names.h"
...
//            float error_distance = 4000;
    ...
    std::tuple<float,float,float> sim_factor(std::tuple<float,float,float> speeds);
        ...
        vector<std::uint64_t> people_ids;

        std::vector<QGraphicsEllipseItem*> people_ellipses;
