...
public:
    ...
    virtual TLaserData getLaserData(::std::string laser_name, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
public:
    ...
    {
        return _makeLamdaOutgoing<::RoboCompLaserMulti::LaserConfData>(response, ex, sent, this, &RoboCompLaserMulti::LaserMultiPrx::_iceI_getLaserConfData, robotid, context);
    }
    ...
    TLaserData getLaserData(const ::std::string& laser_name, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<::RoboCompLaserMulti::TLaserData>(true, this, &LaserMultiPrx::_iceI_getLaserData, laser_name, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getLaserDataAsync(const ::std::string& laser_name, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<::RoboCompLaserMulti::TLaserData>>().get_future())
    {
        return _makePromiseOutgoing<::RoboCompLaserMulti::TLaserData, P>(false, this, &LaserMultiPrx::_iceI_getLaserData, laser_name, context);
    }

    ::std::function<void()>
    getLaserDataAsync(const ::std::string& laser_name,
                      ::std::function<void(::RoboCompLaserMulti::TLaserData)> response,
                      ::std::function<void(::std::exception_ptr)> ex = nullptr,
                      ::std::function<void(bool)> sent = nullptr,
                      const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::RoboCompLaserMulti::TLaserData>(response, ex, sent, this, &RoboCompLaserMulti::LaserMultiPrx::_iceI_getLaserData, laser_name, context);
    }

    /// \cond INTERNAL
    void _iceI_getLaserData(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompLaserMulti::TLaserData>>&, const ::std::string&, const ::Ice::Context&);
    /// \endcond
...
public:
    ...
    ::RoboCompLaserMulti::TLaserData getLaserData(const ::std::string& laser_name, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_getLaserData(_iceI_begin_getLaserData(laser_name, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getLaserData(const ::std::string& laser_name, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getLaserData(laser_name, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getLaserData(const ::std::string& laser_name, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getLaserData(laser_name, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getLaserData(const ::std::string& laser_name, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getLaserData(laser_name, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getLaserData(const ::std::string& laser_name, const ::RoboCompLaserMulti::Callback_LaserMulti_getLaserDataPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getLaserData(laser_name, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getLaserData(const ::std::string& laser_name, const ::Ice::Context& context, const ::RoboCompLaserMulti::Callback_LaserMulti_getLaserDataPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getLaserData(laser_name, context, cb, cookie);
    }
...
private:
    ...
    ::Ice::AsyncResultPtr _iceI_begin_getLaserData(const ::std::string&, const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual TLaserData getLaserData(const ::std::string& laser_name, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getLaserData(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
