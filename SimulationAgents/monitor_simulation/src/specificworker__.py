...
class SpecificWorker(GenericWorker):
    ...
    def processing(self):
        ...
        for result in fullresult:
            ...
            for i in range(0, len(actor_info)):
                if (len(actor_info[i]['fullPose'])>0):
                    ...
                    # self.x_final_car.append()
                    # self.y_final_car.append()
        ...
        plt.scatter(x_init_person, y_init_person, s=15)
        plt.scatter(x_final_person, y_final_person, s=15)
