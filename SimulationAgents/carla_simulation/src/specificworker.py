...
def carla_fun():
    ports = [2000, 4000, 6000, 7000, 3000, 5000]#, 60000, 63000]
    ...
    for i in range(0, z):
        ...
        client = carla.Client("192.168.50.144", p)
    ...
    def compute(self):
        ...
        if self.cond_simulation is not None:
            ...
            for i in self.servers:
                ...
                self.cond_simulation, i, self.revision_time, self.fixed_delta_seconds, f'sim{c}', 4))
                t1.start()
                c += 1
